...
helper.log = (type, ...values) => {
    ...
    console.log(helper.date() + " " + helper.time() + outType +  ("undefined" !== typeof window ? "" : error), ...values.map((value) => typeof window !== "undefined" ? (Object.keys(value).reduce((result, key) => (typeof value[key] === "function" ? result : {...result, [key]: value[key]}),{})) : helper.stringify(value)))
